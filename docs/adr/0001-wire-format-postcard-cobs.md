...
The encode-only/decode-closed boundary above applies to the UART wire path; decode of persisted frames within this repo — a separate, versioned storage-replay contract — was added later by [ADR-0003](0003-versioned-persisted-frame-codec.md).
